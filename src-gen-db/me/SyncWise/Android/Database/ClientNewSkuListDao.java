...
/** 
 * DAO for table ClientNewSkuList.
*/
public class ClientNewSkuListDao extends AbstractDao<ClientNewSkuList, Long> {

    public static final String TABLENAME = "ClientNewSkuList";

    /**
     * Properties of entity ClientNewSkuList.<br/>
    ...
    */
    ...
    public ClientNewSkuListDao(DaoConfig config) {
        super(config);
    }
    
    public ClientNewSkuListDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ClientNewSkuList' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ClientNewSkuList'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ClientNewSkuList entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ClientNewSkuList readEntity(Cursor cursor, int offset) {
        ClientNewSkuList entity = new ClientNewSkuList( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ClientNewSkuList entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ClientNewSkuList entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ClientNewSkuList entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
