...
/** 
 * DAO for table TransactionDetailsMissedMSL.
*/
public class TransactionDetailsMissedMSLDao extends AbstractDao<TransactionDetailsMissedMSL, Long> {

    public static final String TABLENAME = "TransactionDetailsMissedMSL";

    /**
     * Properties of entity TransactionDetailsMissedMSL.<br/>
    ...
    */
    ...
    public TransactionDetailsMissedMSLDao(DaoConfig config) {
        super(config);
    }
    
    public TransactionDetailsMissedMSLDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TransactionDetailsMissedMSL' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TransactionDetailsMissedMSL'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TransactionDetailsMissedMSL entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TransactionDetailsMissedMSL readEntity(Cursor cursor, int offset) {
        TransactionDetailsMissedMSL entity = new TransactionDetailsMissedMSL( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TransactionDetailsMissedMSL entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TransactionDetailsMissedMSL entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TransactionDetailsMissedMSL entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
