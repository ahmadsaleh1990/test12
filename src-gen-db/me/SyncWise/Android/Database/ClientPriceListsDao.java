...
/** 
 * DAO for table ClientPriceLists.
*/
public class ClientPriceListsDao extends AbstractDao<ClientPriceLists, Long> {

    public static final String TABLENAME = "ClientPriceLists";

    /**
     * Properties of entity ClientPriceLists.<br/>
    ...
    */
    public static class Properties {
        ...
        public final static Property PriceListCode = new Property(2, String.class, "PriceListCode", false, "PriceListCode");
    ...
    public ClientPriceListsDao(DaoConfig config) {
        super(config);
    }
    
    public ClientPriceListsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ClientPriceLists' (" + //
                "'_id' INTEGER PRIMARY KEY ," + // 0: id
                "'ClientCode' TEXT NOT NULL ," + // 1: ClientCode
                "'PriceListCode' TEXT NOT NULL ," + // 2: PriceListCode
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ClientPriceLists'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ClientPriceLists entity) {
        stmt.clearBindings();
        ...
        stmt.bindString(3, entity.getPriceListCode());
    ...
    /** @inheritdoc */
    @Override
    public ClientPriceLists readEntity(Cursor cursor, int offset) {
        ClientPriceLists entity = new ClientPriceLists( //
            cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0), // id
            cursor.getString(offset + 1), // ClientCode
            cursor.getString(offset + 2), // PriceListCode
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ClientPriceLists entity, int offset) {
        entity.setId(cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0));
        entity.setClientCode(cursor.getString(offset + 1));
        entity.setPriceListCode(cursor.getString(offset + 2));
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(ClientPriceLists entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(ClientPriceLists entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
