...
public class DuoActivity extends Activity   { 
    ...
    class PingRequest extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
		 AppDialog.getInstance().displayIndeterminateProgress(DuoActivity.this, "Wait Duo ", "");
		}
        ...
        protected void onPostExecute(String s) {
            ...
            }else
            {
            	 ...
            	 Baguette.showText ( DuoActivity.this , "probem Duo "+s , Baguette.BackgroundColor.RED );
            }
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                if (!Jobject.getString("stat").equals("OK")) {
                	...
                	//  generateNoteOnSD(  "stat", Jobject.getString("stat").toString());
                	return Jobject.getString("stat").toString();
                }
                return "Success";
            } catch (Exception e) {
                e.printStackTrace();
    ...
    class AuthRequest extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
        	...
        	if(s.equals("Success")){
        		...
        		AppDialog.getInstance ().displayAlert ( DuoActivity.this ,
        				null ,
        				s ,
            ...
            Toast.makeText( DuoActivity.this, s, Toast.LENGTH_LONG).show();
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                JSONObject JResponse = Jobject.getJSONObject("response");
                if (!Jobject.getString("stat").equals("OK")) {
                    return "stat" +Jobject.getString("stat").toString();//"Error";
                }
