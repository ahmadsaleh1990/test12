...
/**
 * A concrete BaseAdapter that is backed by an array of {@link me.SyncWise.Android.Modules.SalesInvoice.InvoiceInfo InvoiceInfo} objects.
 * 
 * @author Elias
 *
 */
public class InvoiceInfoAdapter extends ArrayAdapter < InvoiceInfo > {
	 ...
	 * @param salesInvoiceDetailItems	List of {@link me.SyncWise.Android.Modules.SalesInvoice.InvoiceInfo InvoiceInfo} objects.
	 */
	public InvoiceInfoAdapter ( Context context , int layout , List < InvoiceInfo > salesInvoiceDetailItems ) {
