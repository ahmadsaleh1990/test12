...
/**
 * Fragment used to represent a modular section to collection amount analysis.
 * 
 * @author Elias
 *
 */
public class CollectionAmountFragment extends ListFragment {

	/**
	 * Bundle key used to put/retrieve data.
	 */
	public static final String LAYOUT = OrderAmountFragment.class.getName () + ".LAYOUT";
	...
	public void onActivityCreated ( Bundle savedInstanceState ) {
		...
		( (TextView) getView ().findViewById ( R.id.label_currency ) ).setText ( AppResources.getInstance ( getActivity () ).getString ( getActivity () , R.string.target_currency_label ) );
		...
		setListAdapter ( ( (TargetActivity) getActivity () ).getTargetCollectionAmountsAdapter ( null ) );
	}
