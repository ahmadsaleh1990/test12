...
/**
 * Fragment used to represent a modular section to order amount per client per brand analysis.
 * 
 * @author Elias
 *
 */
public class OrderAmountPerClientPerBrandFragment extends ListFragment {

	/**
	 * Bundle key used to put/retrieve data.
	 */
	public static final String LAYOUT = OrderAmountPerClientPerBrandFragment.class.getName () + ".LAYOUT";
	...
	public void onActivityCreated ( Bundle savedInstanceState ) {
		...
		( (TextView) getView ().findViewById ( R.id.label_client_item_division ) ).setText ( AppResources.getInstance ( getActivity () ).getString ( getActivity () , R.string.target_clients_label )
				+ " - " + AppResources.getInstance ( getActivity () ).getString ( getActivity () , R.string.target_items_label )
				+ " - " + AppResources.getInstance ( getActivity () ).getString ( getActivity () , R.string.target_divisions_label ));
		...
		setListAdapter ( ( (TargetActivity) getActivity () ).getTargetOrderAmountsPerClientPerBrandAdapter ( null ) );
	}
