...
/**
 * Fragment used to represent a modular section to visits frequency analysis.
 * 
 * @author Elias
 *
 */
public class VisitsFrequencyFragment extends ListFragment {

	/**
	 * Bundle key used to put/retrieve data.
	 */
	public static final String LAYOUT = VisitsFrequencyFragment.class.getName () + ".LAYOUT";
	...
	public void onActivityCreated ( Bundle savedInstanceState ) {
		...
		( (TextView) getView ().findViewById ( R.id.label_user ) ).setText ( AppResources.getInstance ( getActivity () ).getString ( getActivity () , R.string.target_users_label ) );
		( (TextView) getView ().findViewById ( R.id.label_target ) ).setText ( AppResources.getInstance ( getActivity () ).getString ( getActivity () , R.string.target_frequency_label ) );
		...
		setListAdapter ( ( (TargetActivity) getActivity () ).getTargetVisitsAdapter ( null ) );
	}
