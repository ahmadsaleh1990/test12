...
/**
 * Fragment used to represent a modular section to order amount analysis.
 * 
 * @author Elias
 *
 */
public class OrderAmountFragment extends ListFragment{
	...
	public void onActivityCreated ( Bundle savedInstanceState ) {
		...
		setListAdapter ( ( (TargetActivity) getActivity () ).getTargetOrderAmountsAdapter ( null ) );
	}
