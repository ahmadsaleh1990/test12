...
/**
 * Class used to represent the target coverage related to order amounts.
 * 
 * @author Elias
 *
 */
public class TargetOrders implements Target {
	 ...
	 */
	public TargetOrders ( final Context context , final String currencyDescription , final double requiredAmount , final double achievedAmount , final DecimalFormat moneyFormat ) {
