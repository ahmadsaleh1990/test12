...
/**
 * Fragment used to represent a modular section to items quantity analysis.
 * 
 * @author Elias
 *
 */
public class ItemsQuantityFragment extends ListFragment {

	/**
	 * Bundle key used to put/retrieve data.
	 */
	public static final String LAYOUT = ItemsQuantityFragment.class.getName () + ".LAYOUT";
	...
	public void onActivityCreated ( Bundle savedInstanceState ) {
		...
		( (TextView) getView ().findViewById ( R.id.label_item ) ).setText ( AppResources.getInstance ( getActivity () ).getString ( getActivity () , R.string.target_items_label ) );
		( (TextView) getView ().findViewById ( R.id.label_target ) ).setText ( AppResources.getInstance ( getActivity () ).getString ( getActivity () , R.string.target_quantity_label ) );
		...
		setListAdapter ( ( (TargetActivity) getActivity () ).getTargetItemsAdapter ( null ) );
	}
