...
public class CashOrderRFRAdapter extends ArrayAdapter < OrderRFRInfo >  {
	...
	private final int layout;
 	...
 	public static class ViewHolder {
 		public OrderRFRInfo order;
 		public int position;
 		public CheckBox chkbox;
  
 	}
 	public CashOrderRFRAdapter ( Context context , int layout , List < OrderRFRInfo > salesInvoiceDetailItems, final boolean itemsEnabled ) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.chkbox.setEnabled(itemsEnabled);
    	...
    	//	viewHolder.chkbox.setOnCheckedChangeListener ( null );
		final OrderRFRInfo finalOrder = viewHolder.order;
