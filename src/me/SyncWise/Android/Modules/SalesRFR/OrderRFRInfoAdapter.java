 ...
 *
 */
public class OrderRFRInfoAdapter extends ArrayAdapter < OrderRFRInfo > {
	...
	public OrderRFRInfoAdapter ( Context context , int layout , List < OrderRFRInfo > salesOrderDetailItems ) {
