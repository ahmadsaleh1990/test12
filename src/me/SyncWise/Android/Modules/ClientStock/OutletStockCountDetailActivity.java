...
public class OutletStockCountDetailActivity extends ListActivity implements SearchView.OnQueryTextListener , QuickAction.OnActionItemClickListener , OnDateSetListener , OnClickListener , OnItemSelectedListener , OnFocusChangeListener {
	 ...
	 */
	public static final String REQUEST_CODE = OutletStockCountDetailActivity.class.getName () + ".REQUEST_CODE";
	 ...
	 */
	public static final String IS_EDIT = OutletStockCountDetailActivity.class.getName () + ".IS_EDIT";
	
	/**
	 * Bundle key used to put/retrieve the content of the view only flag.
	 */
	public static final String IS_VIEW_ONLY = OutletStockCountDetailActivity.class.getName () + ".IS_VIEW_ONLY";	
	
	/**
	 * Bundle key used to put/retrieve the content of {@link #displaysTOCKDetails}.
	 */
	private static final String DISPLAY_STOCK_DETAILS = OutletStockCountDetailActivity.class.getName () + ".DISPLAY_STOCK_DETAILS";
	 ...
	 */
	private static final String STOCK_MODIFICATION = OutletStockCountDetailActivity.class.getName () + ".STOCK_MODIFICATION";
	 ...
	 */
	private static final String DISPLAY_STOCK_NOTE = OutletStockCountDetailActivity.class.getName () + ".DISPLAY_STOCK_NOTE";
	 ...
	 */
	public static final String ITEMS_LIST_MODE = OutletStockCountDetailActivity.class.getName () + ".ITEMS_LIST_MODE";
	
	/**
	 * Integer used to host the item list mode.
	 * @see #OUTLET_ITEMS_LIST
	 * @see #ASSETS_LIST
	 */
	 ...
	 */
	//public static final int OUTLET_ITEMS_LIST = 1;
	...
	/**
	 * Constant integer holding the items list mode used to display the OUTLET list.
	 */
	public static final int OUTLET_ITEMS_LIST=3;
	/**
	 ...
	 */
	public static final String CLIENT_STOCK_HEADER_CODE = OutletStockCountDetailActivity.class.getName () + ".CLIENT_STOCK_HEADER_CODE";
	
	/**
	 * Bundle key used to put/retrieve the content of the current call.
	 */
	public static final String CALL = OutletStockCountDetailActivity.class.getName () + ".CALL";
	
	/**
	 * Bundle key used to put/retrieve the content of {@link #visit}.
	 */
	public static final String VISIT = OutletStockCountDetailActivity.class.getName () + ".VISIT";
	 ...
	 */
	public static final String SELECTED_DIVISIONS = OutletStockCountDetailActivity.class.getName () + ".SELECTED_DIVISIONS";
	 ...
	 */
	public static final String STOCK = OutletStockCountDetailActivity.class.getName () + ".STOCK";
	 ...
	 */
	public static final String SEARCH_QUERY = OutletStockCountDetailActivity.class.getName () + ".SEARCH_QUERY";
	 ...
	 */
	public static final String NOTE = OutletStockCountDetailActivity.class.getName () + ".NOTE";
	 ...
	 */
	public static final String EXPIRY_DATE = OutletStockCountDetailActivity.class.getName () + ".EXPIRY_DATE";
	 ...
	 */
	public static final String COUNT_TYPE = OutletStockCountDetailActivity.class.getName () + ".COUNT_TYPE";
	
	/**
	 * Bundle key used to put/retrieve the content of {@link #currency}.
	 */
	public static final String CURRENCY = OutletStockCountDetailActivity.class.getName () + ".CURRENCY";
	 ...
	 */
	public static final String CLIENTSTOCK_HEADER = OutletStockCountDetailActivity.class.getName () + ".CLIENTSTOCK_HEADER";
	 ...
	 */
	public static final String CLIENTSTOCK_DETAILS = OutletStockCountDetailActivity.class.getName () + ".CLIENTSTOCK_DETAILS";
	 ...
	 */
	public static final String CLIENT_ASSETS = OutletStockCountDetailActivity.class.getName () + ".CLIENT_ASSETS";
	...
	public void onCreate ( Bundle savedInstanceState ) {
		...
		setTitle ( AppResources.getInstance ( this ).getString ( this , R.string.outlet_stock_count_activity_title ) );
		...
		if ( itemsListMode == 0 )
			...
			itemsListMode = OUTLET_ITEMS_LIST;
		...
		findViewById ( R.id.button_date_picker ).setOnClickListener ( new View.OnClickListener () {
			...
			public void onClick ( View view ) {
				...
				AppDialog.getInstance ().displayDatePicker ( OutletStockCountDetailActivity.this , defaultDate.get ( Calendar.YEAR ) , defaultDate.get ( Calendar.MONTH ) , defaultDate.get ( Calendar.DAY_OF_MONTH ) , null , false , true , OutletStockCountDetailActivity.this , OutletStockCountDetailActivity.this );
			}
		} );
	...
	private void displayItemsListMode () {
		...
		else if ( itemsListMode == OUTLET_ITEMS_LIST )
    ...
    protected void onSaveInstanceState ( Bundle outState ) {
		...
		ActivityInstance.saveDataGson ( this , OutletStockCountDetailActivity.class.getName () , STOCK , stocks );
	...
	public void onBackPressed () {
		...
		// Determine if the request code is INFO
    		...
    		if ( getIntent ().getBooleanExtra ( IS_VIEW_ONLY , false ) )
				...
				setListAdapter ( getOutletStockDetailsAdapter ( R.layout.sales_order_details_activity_item , new ArrayList < Stock > () , currency.getCurrencyRounding () , true ) );
					...
					new DialogInterface.OnClickListener () {
						...
						public void onClick ( DialogInterface dialog , int which ) {
							...
							case DialogInterface.BUTTON_POSITIVE:
								...
								OutletStockCountDetailActivity.this.finish ();
								break;
    ...
    protected void onListItemClick ( ListView listView , View view , final int position , long id ) {
    	...
    	if ( requestCode != REQUEST_CODE_INFO ) {
    		...
    		if ( ItemsUtils.isRegular ( stockModification.getItem () ) && stockModification.isMustStockList () && ! stockModification.isConfirmed () ) {
    			...
    			// Refresh the list
    			( (OutletStockDetailsAdapter) getListAdapter () ).notifyDataSetChanged ();
    		} // End if
    		else {
	    		// Set flag
	...
	protected void initializeTertiaryView ( final boolean restore ) {
		...
		if ( getIntent ().getIntExtra ( ITEMS_LIST_MODE , 0 ) == OutletStockCountDetailActivity.ASSETS_LIST )
	...
	public void updateStock ( View view ) {
		...
		if ( ItemsUtils.isRegular ( stockModification.getItem () ) ) {
			...
			if ( expiryDate != null ) {
				...
				if ( ( expiryDate.before ( sixMonths.getTime () ) && overSixMonths == true )
					...
					Baguette.showText ( OutletStockCountDetailActivity.this ,
							AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.client_stock_count_expiry_date_inconsistency_message ) ,
			...
			if ( quantityBig.getNumber () != 0 || quantityMedium.getNumber () != 0 || quantitySmall.getNumber () != 0 ) {
				...
				if ( overSixMonths == false || ( overSixMonths == true && PermissionsUtils.getEnforceStockExpiryDate ( this , DatabaseUtils.getCurrentUserCode ( this ) , DatabaseUtils.getCurrentCompanyCode ( this ) ) ) )
					...
					if ( expiryDate == null ) {
						...
						Baguette.showText ( OutletStockCountDetailActivity.this ,
								AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.client_stock_count_invalid_expiry_date_message ) ,
								Baguette.BackgroundColor.RED );
						// Exit method
						return;
					} // End if
		...
		// Check if the item is an asset
			...
			if ( existence != null && existence.getStatusID () == 1 )
				...
				if ( statusSpinner.getSelectedItemPosition () == 0 ) {
					// Indicate that the expiry date is missing
					Baguette.showText ( OutletStockCountDetailActivity.this ,
							AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.client_stock_count_invalid_asset_statuses_message ) ,
							Baguette.BackgroundColor.RED );
					// Exit method
					return;
				} // End if
		...
		stockModification.setQuantitySmall ( (int) quantitySmall.getNumber () );
		// Update the expiry date
	...
	private void onOrderModificationResult () {
		...
		// Check if the request code is INFO
		// AND if the selected client stock counts list is empty
		if ( OutletStockCountDetailActivity.this.requestCode == REQUEST_CODE_INFO && selectedStocks != null && selectedStocks.isEmpty () )
			// Emulate a back key press
			onBackPressed ();
		else
	    	// Refresh the list
    ...
    public boolean onCreateOptionsMenu ( Menu menu ) {
    	...
    	if ( requestCode != REQUEST_CODE_INFO ) {
    		...
    		if ( itemsListMode == OUTLET_ITEMS_LIST )
    ...
    public boolean onOptionsItemSelected ( MenuItem menuItem ) {
    		...
    		AppDialog.getInstance ().displayList ( this ,
    				...
    				new DialogInterface.OnClickListener () {
    					...
    					public void onClick ( DialogInterface dialog , int which ) {
    				    	...
    				    	if ( which == 0 && itemsListMode != OUTLET_ITEMS_LIST ) {
    	...
    	// Determine if the action basket is selected
    		...
    		for ( Stock stock : stocks ) {
            	...
            	if ( getIntent ().getIntExtra ( ITEMS_LIST_MODE , 0 ) != OutletStockCountDetailActivity.ASSETS_LIST && stock.isMustStockList () && ! stock.isConfirmed () ) {
            		// Reset flag
    		...
    		if ( clientstocks.isEmpty () ) {
    			...
    			String baguetteMessage = AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.no_client_stock_message );
    			if ( getIntent ().getIntExtra ( ITEMS_LIST_MODE , 0 ) == OutletStockCountDetailActivity.ASSETS_LIST )
    				baguetteMessage = AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.no_client_asset_message );
				// Indicate that some clients were removed
				Baguette.showText ( OutletStockCountDetailActivity.this , baguetteMessage , Baguette.BackgroundColor.RED );
        		// Consume event
        		return true;
    		} // End if
			...
			adapter.addSection ( new Section ( detailsLabel , null , Section.BackgroundType.COLOR , Color.argb ( 63 , 0 , 0 , 0 ) , null ) ,
					getOutletStockDetailsAdapter ( R.layout.sales_order_details_activity_item , selectedStocks , currency.getCurrencyRounding () , ! getIntent ().getBooleanExtra ( IS_VIEW_ONLY , false ) ) );
    	...
    	// Determine if the action save is selected
			...
			if ( clientStockHeader == null && clientStockDetails == null && clientAssets == null ) {
	    		try {
					...
					int clientStockCountSequence = DatabaseUtils.getUserSequence ( this , user.getUserCode () , user.getCompanyCode () , TransactionSequencesDao.Properties.ClientStockCount );
					// Begin transaction
					DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getDatabase ().beginTransaction ();
		    		// Compute the transaction header code
		    		String clientstockHeaderCode = "1" + String.valueOf ( user.getPrefixID () ) + sequence.format ( clientStockCountSequence );
					...
					for ( int i = 0 ; i < selectedStocks.size () ; i ++ ) {
						...
						if ( ItemsUtils.isRegular ( selectedStocks.get ( i ).getItem () ) )
							...
							DatabaseUtils.getInstance ( this ).getDaoSession ().getClientStockCountDetailsDao ().insert ( new ClientStockCountDetails ( null , // ID
									...
									(double) selectedStocks.get ( i ).getQuantityBig () , // QuantityBig
									...
									(double) selectedStocks.get ( i ).getShelfPriceBig() , // Shelf PriceBig
									(double) selectedStocks.get ( i ).getShelfPriceMedium() , // Shelf PriceMedium
									(double) selectedStocks.get ( i ).getShelfPriceSmall() , // /shelf PriceSmall
									note , // Note
									null , // ReasonCode
					...
					// Commit changes
					DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getDatabase ().setTransactionSuccessful ();
					// Indicate that the save was successful
					Vibration.vibrate ( OutletStockCountDetailActivity.this );
	    		} catch ( Exception exception ) {
					// Indicate that an error occurred
					error = true;
	    		} finally {
					// End transaction
					DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getDatabase ().endTransaction ();
				...
				DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientStockCountHeadersDao().refresh ( clientStockHeader );
				...
				for ( Stock stock : selectedStocks )
					...
					if ( ItemsUtils.isRegular ( stock.getItem () ) ) {
						...
						if ( _clientStockDetails.containsKey ( stock.getItem ().getItemCode () ) ) {
							...
							clientStockDetail.setBasicUnitQuantity ( (double) stock.getQuantityBig () * stock.getItem ().getUnitBigMedium () * stock.getItem ().getUnitMediumSmall ()
							...
							addItems.add ( new ClientStockCountDetails ( null , // ID
									...
									(double) stock.getQuantityBig () , // QuantityBig
									...
									(double) stock.getShelfPriceBig () , // ShelfPriceBig
									(double) stock.getShelfPriceMedium () , // ShelfPriceMedium
									(double) stock.getShelfPriceSmall () , // ShlefPriceSmall
									note , // Note
									null , // ReasonCode
	 ...
	 */
	protected ListAdapter getOutletStockDetailsAdapter ( int layout , List < Stock > stockItems , final int currencyRounding , final boolean itemsEnabled ) {
		return new OutletStockDetailsAdapter ( this , layout , stockItems , currencyRounding , itemsEnabled );
	}
		...
		for ( Stock stock : stockItems )
			if ( ItemsUtils.isRegular ( stock.getItem () ) ) {
				...
				if ( _clientStockDetails.containsKey ( stock.getItem ().getItemCode () ) ) {
					...
					if ( ! clientStockCountDetails.getQuantityBig ().equals ( (double) stock.getQuantityBig () )
	...
	protected ArrayList < Stock > filter () {
		...
		for ( Stock stock : stocks ) {
			...
			if ( itemsListMode != OUTLET_ITEMS_LIST && itemsListMode != ASSETS_LIST )
				continue;
			else if ( itemsListMode == OUTLET_ITEMS_LIST && ( ! ItemsUtils.isRegular ( stock.getItem () ) ) )
				continue;
	...
	private class PopulateList extends AsyncTask < Void , Void , ArrayList < Stock > > {
		...
		protected ArrayList < Stock > doInBackground ( Void ... params ) {
			try {
				...
				String userCode = DatabaseUtils.getCurrentUserCode ( OutletStockCountDetailActivity.this );
				String companyCode = DatabaseUtils.getCurrentCompanyCode ( OutletStockCountDetailActivity.this );
...
//					statuses.add ( new AssetsStatus ( null , Integer.MIN_VALUE , Integer.MIN_VALUE , null , "------" , "------" , null ) );
					...
					statuses.addAll ( DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getAssetsStatusDao ().queryBuilder ()
...
//					existence.add ( new AssetsStatus ( null , Integer.MIN_VALUE , Integer.MIN_VALUE , null , "------" , "------" , null ) );
					...
					existence.addAll ( DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getAssetsStatusDao ().queryBuilder ()
				...
				if ( currency == null ) {
					...
					cursor = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getDatabase ().rawQuery ( SQL , selectionArguments );
					// Move the cursor to the first raw
					if ( cursor.moveToFirst () ) {
						do {
							// Retrieve the current currency
							currency = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getCurrenciesDao ().readEntity ( cursor , 0 );
				...
				if ( getIntent ().getStringExtra ( CLIENT_STOCK_HEADER_CODE ) != null && clientStockHeader == null ) {
					...
					clientStockHeader = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientStockCountHeadersDao ().queryBuilder ()
					...
					if ( clientStockHeader != null ) {
						...
						clientStockDetails.addAll ( DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientStockCountDetailsDao ().queryBuilder ()
						...
						clientAssets.addAll ( DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientAssetStatusDao ().queryBuilder ()
								.where ( ClientAssetStatusDao.Properties.TransactionCode.eq ( getIntent ().getStringExtra ( CLIENT_STOCK_HEADER_CODE ) ) ).list () );
						// Iterate over all transaction details
						for ( ClientStockCountDetails clientStockDetail : clientStockDetails )
							// Refresh object
							DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientStockCountDetailsDao ().refresh ( clientStockDetail );
						// Iterate over all transaction details
						for ( ClientAssetStatus clientAssetStatus : clientAssets )
							// Refresh object
							DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientAssetStatusDao ().refresh ( clientAssetStatus );
						// Retrieve the appropriate currency
						currency = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getCurrenciesDao ().queryBuilder ()
				...
				List < Divisions > allDivisions = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getDivisionsDao ().queryBuilder ()
						.where ( DivisionsDao.Properties.CompanyCode.eq ( companyCode ) ).list ();
				// Retrieve the divisions linked to the user
				List < Divisions > directUserDivisions = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getDivisionsDao ()
				...
				if ( cursor.moveToFirst () ) {
					do {
						...
						Prices price = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getPricesDao ().readEntity ( cursor , 0 );
				...
				if ( divisions == null ) {
					...
					OutletStockCountDetailActivity.this.divisions.addAll ( allUserDivisions );
				} // End if
				...
				if ( retrieveStocks ) {
					...
					stocks = (ArrayList < Stock >) ActivityInstance.readDataGson ( OutletStockCountDetailActivity.this , OutletStockCountDetailActivity.class.getName () , STOCK , new TypeToken < ArrayList < Stock > > () {}.getType () );
					...
					List < ItemDivisions > itemDivisions = EntityUtils.queryByGroup ( selectedDivisionsCodes ,
							DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getItemDivisionsDao () ,
					...
					items = EntityUtils.queryByGroup ( itemCodes ,
							DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getItemsDao () ,
							ItemsDao.Properties.ItemCode );
					
					// Add all assets
					items.addAll ( DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getItemsDao ().queryBuilder ()
					...
					List < ItemBarcodes > itemBarcodes = EntityUtils.queryByGroup ( itemCodes ,
							DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getItemBarcodesDao () ,
					...
					List < Units > units = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getUnitsDao ().loadAll ();
					...
					List < Taxes > taxes = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getTaxesDao ().loadAll ();
					...
					List < ClientMustStockList > clientMustStockList = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientMustStockListDao ()
					...
					List < ClientItemHistory > clientItemHistory = DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientItemHistoryDao ().queryBuilder ()
							.where ( ClientItemHistoryDao.Properties.ClientCode.eq ( clientCode ) ,
									ClientItemHistoryDao.Properties.DivisionCode.eq ( DatabaseUtils.getCurrentDivisionCode ( OutletStockCountDetailActivity.this ) ) ,
									ClientItemHistoryDao.Properties.CompanyCode.eq ( DatabaseUtils.getCurrentCompanyCode ( OutletStockCountDetailActivity.this ) ) ).list ();
					...
					boolean isMSLConfirmationRequired = PermissionsUtils.getEnforceMSLConfirmation ( OutletStockCountDetailActivity.this , userCode , companyCode );
					// Determine if the current client has previous client stock count
					boolean hasPreviousOrders = visit == null ? false : DatabaseUtils.getInstance ( OutletStockCountDetailActivity.this ).getDaoSession ().getClientStockCountHeadersDao ().queryBuilder ()
					...
					for ( Items item : items ) {
						...
						if ( _clientStockDetails.containsKey ( stock.getItem ().getItemCode () ) ) {
							...
							stock.setQuantitySmall ( clientStockDetails.getQuantitySmall ().intValue () );
							// Set the client stock count prices
		...
		protected void onPostExecute ( ArrayList < Stock > stocks ) {
			...
			if ( error ) {
				// Indicate that the activity cannot be displayed
				new AppToast ( OutletStockCountDetailActivity.this )
					.setIcon ( R.drawable.warning )
					.setText ( AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.missing_client_currency_price_list_message ) )
					.setDuration ( Toast.LENGTH_LONG )
					.show ();
				// Initialize the client stock counts list
				OutletStockCountDetailActivity.this.stocks = new ArrayList < Stock > ();
				// Exit method
				return;
			} // End if
    		...
    		AssetStatusAdapter existenceAdapter = new AssetStatusAdapter ( OutletStockCountDetailActivity.this , android.R.layout.simple_spinner_item , existence );
    		...
    		AssetStatusAdapter statusesAdapter = new AssetStatusAdapter ( OutletStockCountDetailActivity.this , android.R.layout.simple_spinner_item , statuses );
			// Sets the layout resource to create the drop down views
			...
			if ( requestCode != REQUEST_CODE_INFO )
				// Set a new adapter
				setListAdapter ( getOutletStockDetailsAdapter ( R.layout.sales_order_details_activity_item , new ArrayList < Stock > ( stocks ) , currency.getCurrencyRounding () , true ) );
			// Otherwise the request code is INFO
			else {
				// Compute labels
				String infoLabel = AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.client_stock_count_details_label );
				if ( getIntent ().getIntExtra ( ITEMS_LIST_MODE , 0 ) == OutletStockCountDetailActivity.ASSETS_LIST )
					infoLabel = AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.client_asset_details_label );
				String detailsLabel = AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.client_stock_count_products_label );
				if ( getIntent ().getIntExtra ( ITEMS_LIST_MODE , 0 ) == OutletStockCountDetailActivity.ASSETS_LIST )
					detailsLabel = AppResources.getInstance ( OutletStockCountDetailActivity.this ).getString ( OutletStockCountDetailActivity.this , R.string.client_asset_products_label );
				
				// Declare and initialize a multiple list adapter
				MultipleListAdapter adapter = new MultipleListAdapter ( OutletStockCountDetailActivity.this );
				// Add the client stock count details adapter
				adapter.addSection ( new Section ( infoLabel , null , Section.BackgroundType.COLOR , Color.argb ( 63 , 0 , 0 , 0 ) , null ) ,
						new StockInfoAdapter ( OutletStockCountDetailActivity.this , R.layout.order_info_item , details ) );
				// Add the client stock count adapter
				adapter.addSection ( new Section ( detailsLabel , null , Section.BackgroundType.COLOR , Color.argb ( 63 , 0 , 0 , 0 ) , null ) ,
						getOutletStockDetailsAdapter ( R.layout.sales_order_details_activity_item , selectedStocks , currency.getCurrencyRounding () , ! getIntent ().getBooleanExtra ( IS_VIEW_ONLY , false ) ) );
				// Set the list adapter
...
//		details.add ( new StockInfo ( StockInfo.ID.TAXES , AppResources.getInstance ( this ).getString ( this , R.string.taxes_label ) , moneyFormat.format ( taxes ) ) );
	...
	private class FilterList extends AsyncTask < Void , Void , ArrayList < Stock > > {
		...
		protected void onPostExecute ( ArrayList < Stock > stocks ) {
			...
			if ( ! OutletStockCountDetailActivity.this.searchQuery.equals ( searchQuery ) )
