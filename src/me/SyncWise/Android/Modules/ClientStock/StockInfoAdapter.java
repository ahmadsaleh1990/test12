...
/**
 * A concrete BaseAdapter that is backed by an array of {@link me.SyncWise.Android.Modules.ClientStock.StockInfo StockInfo} objects.
 * 
 * @author Elias
 *
 */
public class StockInfoAdapter extends ArrayAdapter < StockInfo > {
	...
	public StockInfoAdapter ( Context context , int layout , List < StockInfo > clientStockDetailItems ) {
		// Superclass method call
		super ( context , layout , clientStockDetailItems );
