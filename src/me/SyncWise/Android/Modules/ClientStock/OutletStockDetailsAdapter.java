...
public class OutletStockDetailsAdapter  extends ArrayAdapter < Stock > {
	 ...
	 */
	public OutletStockDetailsAdapter ( Context context , int layout , List < Stock > orderItems , final int currencyRounding , final boolean itemsEnabled ) {
	 ...
	 * @param currencyRounding	Integer used to indicate the currency rounding.
	 */
	public OutletStockDetailsAdapter ( Context context , int layout , List < Stock > orderItems , final int currencyRounding ) {
	...
	public View getView ( int position , View convertView , ViewGroup parent ) {
		...
		if ( ItemsUtils.isRegular ( getItem ( position ).getItem () ) ) {
			...
			viewHolder.code.setText ( TextUtils.concat ( code , newLine , expiryDate , newLine , merchandize , newLine , overSixMonths ) , BufferType.SPANNABLE );
		} // End if
