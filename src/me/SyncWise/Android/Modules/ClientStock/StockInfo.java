...
/**
 * Class used to represent a client stock count detail.
 * 
 * @author Elias
 *
 */
public class StockInfo implements Serializable {
	...
	public static class ID {
		...
		public static final int TOTAL_VALUE = 5;
	}
	 ...
	 */
	public StockInfo ( final int Id , final String description , final String value ) {
