...
public class OrderDirectReturnInfoAdapter extends ArrayAdapter < OrderDirectReturnInfo > {
	...
	public OrderDirectReturnInfoAdapter ( Context context , int layout , List < OrderDirectReturnInfo > salesOrderDetailItems ) {
