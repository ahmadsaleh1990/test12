...
public class ReasonAdapter extends ArrayAdapter < Reasons > {
	...
	public View getView ( int position , View convertView , ViewGroup parent ) {
		...
		SpannableString reason = new SpannableString ( getItem ( position ).getReasonName () );
		// Apply style span
	...
	public View getDropDownView ( int position , View convertView , ViewGroup parent ) {
		...
		SpannableString connection = new SpannableString ( index + getItem ( position ).getReasonName () );
		// Apply style span
