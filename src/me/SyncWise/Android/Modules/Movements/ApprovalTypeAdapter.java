...
/**
 * A concrete BaseAdapter that is backed by an array of {@link me.SyncWise.Android.Modules.Movements.ApprovalType ApprovalType} objects.
 * 
 * @author Elias
 *
 */
public class ApprovalTypeAdapter extends ArrayAdapter < ApprovalType > {
	 ...
	 * @param users	List of {@link me.SyncWise.Android.Modules.Movements.ApprovalType ApprovalType} objects.
	 */
	public ApprovalTypeAdapter ( Context context, int layout , List < ApprovalType > types ) {
		// Superclass method call
		super ( context , layout , types );
	...
	public View getView ( int position , View convertView , ViewGroup parent ) {
		...
		SpannableString username = new SpannableString ( getItem ( position ).getDescription () );
		// Apply style span
	...
	public View getDropDownView ( int position , View convertView , ViewGroup parent ) {
		...
		SpannableString username = new SpannableString ( index + getItem ( position ).getDescription () );
		// Apply style span
		username.setSpan ( new StyleSpan ( Typeface.BOLD ) , 0 , username.length () , 0 );
		// Apply color span
