...
/**
 * A concrete BaseAdapter that is backed by an array of {@link me.SyncWise.Android.Modules.Movements.MovementInfo MovementInfo} objects.
 * 
 * @author Elias
 *
 */
public class MovementInfoAdapter extends ArrayAdapter < MovementInfo > {
	 ...
	 * @param movementDetailItems	List of {@link me.SyncWise.Android.Modules.Movements.MovementInfo MovementInfo} objects.
	 */
	public MovementInfoAdapter ( Context context , int layout , List < MovementInfo > movementDetailItems ) {
		// Superclass method call
		super ( context , layout , movementDetailItems );
