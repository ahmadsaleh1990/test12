...
/**
 * A concrete BaseAdapter that is backed by an array of {@link me.SyncWise.Android.Modules.SalesOrder.OrderInfo OrderInfo} objects.
 * 
 * @author Elias
 *
 */
public class OrderInfoAdapter extends ArrayAdapter < OrderInfo > {
	 ...
	 * @param salesOrderDetailItems	List of {@link me.SyncWise.Android.Modules.SalesOrder.OrderInfo OrderInfo} objects.
	 */
	public OrderInfoAdapter ( Context context , int layout , List < OrderInfo > salesOrderDetailItems ) {
		// Superclass method call
		super ( context , layout , salesOrderDetailItems );
